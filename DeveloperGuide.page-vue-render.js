...
with(this){return _c('p',[_v("The view client feature allows users to view the details of a client using their "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(" on the GUI. This includes information not included in the client list cards, such as their last met and policy list.")])}
},function anonymous(
) {
